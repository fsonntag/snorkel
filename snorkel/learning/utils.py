...
def calculate_scores(ntp, nfp, ntn, nfn, nfp_ov=None, nfn_ov=None, title='Scores', print_scores=True):
    ...
    if print_scores:
        ...
        print(title)
        print("========================================")
        print("Pos. class accuracy: {:.2f}".format(100 * pos_acc))
        print("Neg. class accuracy: {:.2f}".format(100 * neg_acc))
        print("Precision            {:.2f}".format(100 * prec))
...
def print_scores_with_overlapping(ntp, nfp, ntn, nfn, nfp_ov, nfn_ov, title='Scores', print_scores=True):
    ...
    if print_scores:
        ...
        print("Recall                                          {:.2f}".format(100 * rec))
        print("F1                                              {:.2f}".format(100 * f1))
        print("Overl. Precision                                {:.2f}".format(100 * prec_ov))
        print("Overl. Recall                                   {:.2f}".format(100 * rec_ov))
        print("Overl. F1                                       {:.2f}".format(100 * f1_ov))
        print("-------------------------------------------------------")
        print("TP: {:.2f} | FP: {:.2f} | TN: {:.2f} | FN: {:.2f} | FP OV: {:.2f} | FN OV: {:.2f}"
