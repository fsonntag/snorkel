...
from dataset_utils.spacy_tools import create_tokenizer
from snorkel.models import construct_stable_id
from snorkel.parsers.parser import Parser, ParserConnection
...
class Spacy(Parser):
    ...
    def load_lang_model(lang):
        ...
        if Spacy.model_installed(lang):
            ...
            model = sp.load(lang, create_make_doc=create_tokenizer)
        else:
            download(lang)
            model = sp.load(lang, create_make_doc=create_tokenizer)
        return model
