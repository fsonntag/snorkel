...
class CombinedRNN(nn.Module):
    ...
    def forward(self,
        ...
        if self.attention:
            context_attention_vectors = self.attention_output(output_context_word, context_x_word_mask,
                                                              self.context_attn_linear_w_1,
                                                              self.context_attn_linear_w_2)
            candidate_attention_vectors = self.attention_output(output_candidate_word, candidate_x_word_mask,
